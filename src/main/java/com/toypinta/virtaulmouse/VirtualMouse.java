...
public class VirtualMouse {
    ...
    public static void main(String[] args) throws AWTException {
        ...
        CvScalar Gminc = cvScalar(20, 150, 75, 0), Gmaxc = cvScalar(40, 255, 255, 0); // Blue
        CvScalar Bminc = cvScalar(40, 50, 60, 0), Bmaxc = cvScalar(80, 255, 255, 0); // Green

//        CvScalar Bminc = cvScalar(95, 150, 75, 0), Bmaxc = cvScalar(145, 255, 255, 0); // Blue
//        CvScalar Gminc = cvScalar(40, 50, 60, 0), Gmaxc = cvScalar(80, 255, 255, 0); // Green
...
//            cvFlip(img1, img1, 1); // Flip Camera Capture
//            cvFlip(imgC, imgC, 1); // Flip Camera Capture
